...
* [Serenity](https://github.com/SerenityOS/serenity) ⭐ 33,860 | 🐛 740 | 🌐 C++ | 📅 2026-09-26 - Graphical Unix-like operating system for x86 computers
* [Windows 95 in Electron](https://github.com/felixrieseberg/windows95) ⭐ 24,237 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-11 - Hobby Windows 95 implementation in Electron
* [Redox](https://github.com/redox-os/redox) ⭐ 16,597 | 🐛 183 | 🌐 Rust | 📅 2026-09-26 - written in Rust
* [Bottlerocket OS](https://github.com/bottlerocket-os/bottlerocket) ⭐ 9,670 | 🐛 201 | 🌐 Rust | 📅 2026-09-22- Linux-based OS meant for hosting containers.
* [FreeRTOS](https://www.freertos.org/), [GitHub](https://github.com/FreeRTOS/FreeRTOS) ⭐ 7,838 | 🐛 36 | 🌐 C | 📅 2026-08-26 - IoT operating system for microcontrollers, by Amazon.
* [NodeOS](https://github.com/NodeOS/NodeOS) ⭐ 7,343 | 🐛 163 | 🌐 Shell | 📅 2023-03-07 - OS using NodeJS and Linux
* [RavynOS](https://github.com/ravynsoft/ravynos) ⭐ 7,037 | 🐛 87 | 🌐 C | 📅 2026-09-06 - A BSD-based OS project that aims to provide an experience like and some compatibility with macOS (formerly known as airyxOS)
* [ToaruOS](https://github.com/klange/toaruos) ⭐ 6,844 | 🐛 65 | 🌐 C | 📅 2026-09-25 - Hobby operating system from scratch
* [tock](https://www.tockos.org/), [GitHub](https://github.com/tock/tock) ⭐ 6,446 | 🐛 216 | 🌐 Rust | 📅 2026-09-26 - A secure embedded operating system for microcontrollers
* [TempleOS](https://github.com/minexew/TempleOS) ⭐ 4,857 | 🐛 22 | 🌐 HolyC | 📅 2023-12-03 - Religious OS :-)
* [Unikraft](https://github.com/unikraft/unikraft) ⭐ 3,866 | 🐛 372 | 🌐 C | 📅 2026-09-25 - A modular unikernel for specialization, high efficiency, performance, and security; Linux/POSIX-compatible; mostly in C
* [Maestro](https://github.com/maestro-os/maestro) ⭐ 3,336 | 🐛 11 | 🌐 Rust | 📅 2026-08-23, [Blog](https://blog.lenot.re) - Operating system written in Rust, aiming to be a lightweight version of Linux
* [Theseus](https://github.com/theseus-os/Theseus) ⭐ 3,204 | 🐛 69 | 🌐 Rust | 📅 2024-09-22 - A modern experimental OS written from scratch in Rust to explore novel OS structure and state management techniques.
* [Nanos](https://github.com/nanovms/nanos) ⭐ 3,193 | 🐛 88 | 🌐 C | 📅 2026-09-21 - Unikernel that is linux-compatible, written in C
* [tilck](https://github.com/vvaltchev/tilck) ⭐ 3,132 | 🐛 0 | 🌐 C | 📅 2026-09-19 - A Tiny Linux-Compatible Kernel.
...
* [PureDarwin](https://github.com/PureDarwin/PureDarwin/wiki) ⭐ 2,720 | 🐛 1 | 🌐 C | 📅 2026-09-19 - PureDarwin is a community project to extend Darwin into a complete, usable operating system
* [gopher-os](https://github.com/gopher-os/gopher-os) ⭐ 2,624 | 🐛 8 | 🌐 Go | 📅 2020-08-29 - A proof of concept OS kernel written in Go
* [ZealOS](https://github.com/Zeal-Operating-System/ZealOS) ⭐ 2,405 | 🐛 58 | 🌐 HolyC | 📅 2026-09-14 - The Zeal Operating System is a modernized, professional fork of the 64-bit Temple Operating System, TempleOS.
* [Vinix](https://github.com/vlang/vinix) ⭐ 2,335 | 🐛 51 | 🌐 V | 📅 2026-09-26 - Vinix is an effort to write a modern, fast, and useful operating system in the V programming language
* [eggos](https://github.com/icexin/eggos) ⭐ 2,327 | 🐛 26 | 🌐 Go | 📅 2023-07-22 - A Go unikernel running on x86 bare metal
* [managarm](https://github.com/managarm/managarm) ⭐ 1,983 | 🐛 221 | 🌐 C++ | 📅 2026-09-26 - Pragmatic microkernel-based OS with fully asynchronous I/O
* [octox](https://github.com/o8vm/octox) ⭐ 1,885 | 🐛 3 | 🌐 Rust | 📅 2025-09-24 - Unix-like OS in Rust inspired by xv6-riscv
* [Thor](https://github.com/wichtounet/thor-os) ⭐ 1,720 | 🐛 2 | 🌐 C++ | 📅 2024-11-19 - 64bit operating system mostly written in C++
* [HelenOS](https://github.com/HelenOS/helenos) ⭐ 1,588 | 🐛 10 | 🌐 C | 📅 2026-09-23 - multikernel multiserver OS
* [Interim](https://github.com/mntmn/interim) ⭐ 1,322 | 🐛 12 | 🌐 C | 📅 2021-06-11 - Minimalist OS with concepts from Lisp machines and Plan9
...
* [DragonOS](https://github.com/fslongjin/DragonOS) ⭐ 1,206 | 🐛 175 | 🌐 Rust | 📅 2026-09-26 - An x86-64 OS build from scratch.
...
* [moros](https://github.com/vinc/moros) ⭐ 1,100 | 🐛 19 | 🌐 Rust | 📅 2026-09-26 - MOROS is a hobby operating system written in Rust for the x86 architecture.
* [soso](https://github.com/ozkl/soso) ⭐ 995 | 🐛 1 | 🌐 C | 📅 2026-07-26 - Simple unix-like operating system written in Nasm assembly and mostly in C
...
* [BareMetal](http://www.returninfinity.com/), [GitHub](https://github.com/ReturnInfinity/BareMetal) ⭐ 926 | 🐛 1 | 🌐 Assembly | 📅 2026-06-12 - 64 bit operating system written in Assembly for x86-64
* [cavOS](https://github.com/malwarepad/cavOS) ⭐ 736 | 🐛 6 | 🌐 C | 📅 2026-06-13 - Amd64 operating system in C. Trying to make a full OS, with a simple and readable codebase
* [Fiwix](https://www.fiwix.org/), [GitHub](https://github.com/mikaku/Fiwix) ⭐ 693 | 🐛 4 | 🌐 C | 📅 2026-09-25 - A UNIX-like kernel for the i386 architecture.
...
* [Animal](https://github.com/frednora/animal) ⭐ 651 | 🐛 9 | 🌐 C | 📅 2026-09-26 - 32 bit multithreaded operating system (formerly Gramado)
...
* [MollenOS](https://github.com/Meulengracht/MollenOS) ⭐ 454 | 🐛 19 | 🌐 C | 📅 2026-09-25 - MollenOS/Vali is a modern operating system that is built with focus on abstraction and a modular design, allowing anyone to port it to any architecture. It currently targets the x86-32 and x86-64 platform
...
* [MentOS](https://github.com/mentos-team/MentOS) ⭐ 308 | 🐛 33 | 🌐 C | 📅 2026-09-22 - An educational 32-bit linux-like Operating System.
...
* [Jehanne](http://jehanne.io/), [GitHub](https://github.com/JehanneOS/jehanne/) ⭐ 291 | 🐛 0 | 🌐 C | 📅 2022-01-06 - OS inspired by Plan9, 9front and Harvey OS
* [hhuOS](https://github.com/hhuOS/hhuOS) ⭐ 237 | 🐛 13 | 🌐 C++ | 📅 2026-09-07 - hhuOS is a small operating system written in C++ and Assembler for the x86-architecture. The main purpose of this project is to show how different aspects of operating systems theory can be implemented and linked together. The system is not aimed to be a full-featured operating system for daily use.
* [rou2exOS](https://github.com/krustowski/rou2exOS) ⭐ 207 | 🐛 7 | 🌐 Rust | 📅 2026-09-26, [Blog](https://blog.vxn.dev/rou2exos-rusted-edition) - A second iteration of the DOS-like hobby OS written in Rust and x86\_64 assembly
...
* [Ethereal](https://github.com/sasdallas/Ethereal) ⭐ 184 | 🐛 0 | 🌐 C | 📅 2026-09-13 - Ethereal is an advanced modular operating system with support for networking and USB as well as a GUI-enabled userspace.
* [BoneOS](https://github.com/Bone-Project/BoneOS) ⭐ 140 | 🐛 13 | 🌐 C | 📅 2024-08-12- OS for everyone built by everyone
* [ExectOS](https://git.codingworkshop.eu.org/xt-sys/exectos), [GitHub](https://github.com/xt-sys/exectos) ⭐ 139 | 🐛 0 | 🌐 C++ | 📅 2026-09-24 - ExectOS is a modern, EFI-enabled, general purpose operating system written from scratch and implementing the XT architecture. It runs on x86 and x86\_64 architectures and provides NT drivers compatibility layer.
...
* [L4re](https://github.com/kernkonzept/l4re-core) ⭐ 105 | 🐛 1 | 🌐 C++ | 📅 2026-09-25 - Operating system and hypervisor for security/safety-critical and virtualization-enabled applications.
* [Northport](https://github.com/DeanoBurrito/northport) ⭐ 103 | 🐛 0 | 🌐 C++ | 📅 2026-09-22 - Monolithic kernel and support libraries for riscv64 and x86\_64.
...
* [ackOS](https://github.com/ackOS-project/ackOS) ⭐ 92 | 🐛 0 | 🌐 C | 📅 2024-12-14 - A simple 64-bit operating system.
...
* [AlmeidaOS](https://github.com/PauloMigAlmeida/AlmeidaOS) ⭐ 67 | 🐛 0 | 🌐 C | 📅 2022-05-05 - x86-64 OS with its own bootloader, scheduler and limited libc all written from scratch
* [JSD-OS](https://github.com/pgrAm/JSD-OS) ⭐ 63 | 🐛 0 | 🌐 C++ | 📅 2022-07-23 - A small operating system for 32 bit x86.
* [KiddieOS](https://github.com/FrancisBFTC/KiddieOS_Development) ⭐ 63 | 🐛 2 | 🌐 Assembly | 📅 2025-10-14 - UNIX-like 64-bit operating system written in Assembly, C++.
* [Mako](https://github.com/AjayMT/mako) ⭐ 63 | 🐛 0 | 🌐 C | 📅 2025-07-12 - Hobby OS for x86 from scratch, written in C
* [Stanix](https://github.com/tayoky/stanix) ⭐ 48 | 🐛 0 | 🌐 C | 📅 2026-09-26 - An open source modular hobby OS in C, with features such as dynamic linking and a page cache.
...
* [AurixOS](https://github.com/aurixos/os) ⭐ 34 | 🐛 0 | 🌐 C | 📅 2026-09-21 - A small multiplatform Operating System designed for developers and creators
...
* [Lateralus OS](https://github.com/bad-antics/lateralus-lang) ⭐ 9 | 🐛 16 | 🌐 Python | 📅 2026-08-01 - Bare-metal OS written in Lateralus with its own pipeline-native programming language, compiler, and VM
...
* [Equinox OS](https://github.com/amnottdevv/Equinox-os) ⭐ 2 | 🐛 0 | 🌐 C | 📅 2026-09-21 - A 32-bit x86 hobby operating system written from scratch in C++17 featuring a self-hosting C compiler, preemptive multitasking, demand paging, FAT32 read/write, a TCP/IP stack with HTTPS, and a built-in LVGL desktop.
...
* [Linux](https://github.com/torvalds/linux) ⭐ 250,285 | 🐛 3 | 🌐 C | 📅 2026-09-26 - Linux kernel
* [MS-DOS](https://github.com/microsoft/MS-DOS) ⚠️ Archived - The original sources of MS-DOS 1.25 and 2.0
* [ReactOS](https://reactos.org/), [Github](https://github.com/reactos/reactos) ⭐ 18,130 | 🐛 201 | 🌐 C | 📅 2026-09-26 - A free Windows-compatible Operating System
* [FreeBSD](https://freebsd.org/), [Github](https://github.com/freebsd/freebsd) ⭐ 9,335 | 🐛 191 | 🌐 C | 📅 2026-09-26 - Unix-like operating system based on the BSD
* [OpenBSD](https://www.openbsd.org/), [Github](https://github.com/openbsd/src) ⭐ 3,885 | 🐛 1 | 🌐 C | 📅 2026-09-26 - Unix-like operating system based on the BSD
* [Darwin XNU](https://github.com/apple-oss-distributions/xnu) ⭐ 3,654 | 🐛 1 | 🌐 C | 📅 2026-06-18 - The XNU kernel source code for use in MacOS and iOS
...
* [Haiku](https://github.com/haiku/haiku) ⭐ 2,346 | 🐛 0 | 🌐 C++ | 📅 2026-09-26 - BeOS inspired OS
* [NetBSD](https://www.netbsd.org/), [Github](https://github.com/netbsd/src) ⭐ 990 | 🐛 16 | 🌐 C | 📅 2026-09-26 - Unix-like operating system based on the BSD
...
* [How to Make a Computer Operating System](https://github.com/SamyPesse/How-to-Make-a-Computer-Operating-System) ⭐ 22,412 | 🐛 86 | 🌐 C | 📅 2021-12-16 - in C++
* [lytlnyblOS](https://github.com/red-mutt/lytlnyblOS) ⭐ 105 | 🐛 0 | 🌐 C | 📅 2026-09-20 - A beginner-friendly guide to building a 32-bit x86 operating system from scratch.
...
* [os-tutorial - How to create an OS from scratch](https://github.com/cfenollosa/os-tutorial) ⭐ 30,730 | 🐛 128 | 🌐 C | 📅 2026-02-04 by Carlos Fenollosa
* [Learning operating system development using Linux kernel and Raspberry Pi](https://github.com/s-matyukevich/raspberry-pi-os) ⭐ 13,939 | 🐛 66 | 🌐 C | 📅 2024-03-29
...
* [Presentation on how the Linux kernel is developed](https://github.com/gregkh/kernel-development) ⭐ 687 | 🐛 0 | 🌐 TeX | 📅 2026-09-17 by Greg Kroah-Hartman
...
* [xairys Linux Kernel Exploitation](https://github.com/xairy/linux-kernel-exploitation) ⭐ 6,643 | 🐛 1 | 📅 2026-09-10

* [syzkaller](https://github.com/google/syzkaller) ⭐ 6,331 | 🐛 635 | 🌐 Go | 📅 2026-09-26 kernel fuzzer
...
* [virtme-ng](https://github.com/arighi/virtme-ng) ⭐ 890 | 🐛 29 | 🌐 Python | 📅 2026-09-18 - quickly build and run kernels inside a virtualized snapshot of your live system
...
* [b4](https://github.com/mricon/b4) ⭐ 141 | 🐛 48 | 🌐 Python | 📅 2026-09-21, [docu](https://b4.docs.kernel.org/en/latest/), a tool to help with email-based patch workflows
...
* [clang-extract](https://github.com/SUSE/clang-extract) ⭐ 33 | 🐛 17 | 🌐 C++ | 📅 2026-09-24 a tool to extract code content from source files using the clang and LLVM infrastructure.
