...
* [Serenity](https://github.com/SerenityOS/serenity) ⭐ 33,804 | 🐛 742 | 🌐 C++ | 📅 2026-08-31 - Graphical Unix-like operating system for x86 computers
* [Windows 95 in Electron](https://github.com/felixrieseberg/windows95) ⭐ 24,219 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-20 - Hobby Windows 95 implementation in Electron
* [Redox](https://github.com/redox-os/redox) ⭐ 16,545 | 🐛 183 | 🌐 Rust | 📅 2026-08-31 - written in Rust
* [Bottlerocket OS](https://github.com/bottlerocket-os/bottlerocket) ⭐ 9,668 | 🐛 196 | 🌐 Rust | 📅 2026-08-28- Linux-based OS meant for hosting containers.
* [FreeRTOS](https://www.freertos.org/), [GitHub](https://github.com/FreeRTOS/FreeRTOS) ⭐ 7,745 | 🐛 36 | 🌐 C | 📅 2026-08-26 - IoT operating system for microcontrollers, by Amazon.
* [NodeOS](https://github.com/NodeOS/NodeOS) ⭐ 7,345 | 🐛 163 | 🌐 Shell | 📅 2023-03-07 - OS using NodeJS and Linux
* [RavynOS](https://github.com/ravynsoft/ravynos) ⭐ 6,942 | 🐛 85 | 🌐 C | 📅 2026-08-19 - A BSD-based OS project that aims to provide an experience like and some compatibility with macOS (formerly known as airyxOS)
* [ToaruOS](https://github.com/klange/toaruos) ⭐ 6,833 | 🐛 65 | 🌐 C | 📅 2026-08-31 - Hobby operating system from scratch
* [tock](https://www.tockos.org/), [GitHub](https://github.com/tock/tock) ⭐ 6,432 | 🐛 202 | 🌐 Rust | 📅 2026-08-31 - A secure embedded operating system for microcontrollers
* [TempleOS](https://github.com/minexew/TempleOS) ⭐ 4,797 | 🐛 17 | 🌐 HolyC | 📅 2023-12-03 - Religious OS :-)
* [Unikraft](https://github.com/unikraft/unikraft) ⭐ 3,838 | 🐛 362 | 🌐 C | 📅 2026-08-24 - A modular unikernel for specialization, high efficiency, performance, and security; Linux/POSIX-compatible; mostly in C
* [Maestro](https://github.com/maestro-os/maestro) ⭐ 3,328 | 🐛 11 | 🌐 Rust | 📅 2026-08-23, [Blog](https://blog.lenot.re) - Operating system written in Rust, aiming to be a lightweight version of Linux
* [Nanos](https://github.com/nanovms/nanos) ⭐ 3,189 | 🐛 84 | 🌐 C | 📅 2026-08-30 - Unikernel that is linux-compatible, written in C
* [Theseus](https://github.com/theseus-os/Theseus) ⭐ 3,186 | 🐛 70 | 🌐 Rust | 📅 2024-09-22 - A modern experimental OS written from scratch in Rust to explore novel OS structure and state management techniques.
* [tilck](https://github.com/vvaltchev/tilck) ⭐ 3,124 | 🐛 0 | 🌐 C | 📅 2026-08-31 - A Tiny Linux-Compatible Kernel.
...
* [Minoca OS](https://github.com/minoca/os) ⭐ 2,794 | 🐛 23 | 🌐 C | 📅 2021-12-17 - General purpose OS, written in C
* [PureDarwin](https://github.com/PureDarwin/PureDarwin/wiki) ⭐ 2,691 | 🐛 1 | 🌐 C | 📅 2026-08-31 - PureDarwin is a community project to extend Darwin into a complete, usable operating system
* [gopher-os](https://github.com/gopher-os/gopher-os) ⭐ 2,623 | 🐛 8 | 🌐 Go | 📅 2020-08-29 - A proof of concept OS kernel written in Go
* [ZealOS](https://github.com/Zeal-Operating-System/ZealOS) ⭐ 2,383 | 🐛 56 | 🌐 HolyC | 📅 2026-07-31 - The Zeal Operating System is a modernized, professional fork of the 64-bit Temple Operating System, TempleOS.
* [eggos](https://github.com/icexin/eggos) ⭐ 2,325 | 🐛 26 | 🌐 Go | 📅 2023-07-22 - A Go unikernel running on x86 bare metal
* [Vinix](https://github.com/vlang/vinix) ⭐ 2,165 | 🐛 24 | 🌐 V | 📅 2026-06-18 - Vinix is an effort to write a modern, fast, and useful operating system in the V programming language
* [managarm](https://github.com/managarm/managarm) ⭐ 1,971 | 🐛 216 | 🌐 C++ | 📅 2026-08-31 - Pragmatic microkernel-based OS with fully asynchronous I/O
* [Thor](https://github.com/wichtounet/thor-os) ⭐ 1,721 | 🐛 2 | 🌐 C++ | 📅 2024-11-19 - 64bit operating system mostly written in C++
* [octox](https://github.com/o8vm/octox) ⭐ 1,637 | 🐛 3 | 🌐 Rust | 📅 2025-09-24 - Unix-like OS in Rust inspired by xv6-riscv
* [HelenOS](https://github.com/HelenOS/helenos) ⭐ 1,586 | 🐛 9 | 🌐 C | 📅 2026-08-24 - multikernel multiserver OS
* [Interim](https://github.com/mntmn/interim) ⭐ 1,316 | 🐛 12 | 🌐 C | 📅 2021-06-11 - Minimalist OS with concepts from Lisp machines and Plan9
...
* [DragonOS](https://github.com/fslongjin/DragonOS) ⭐ 1,204 | 🐛 165 | 🌐 Rust | 📅 2026-08-31 - An x86-64 OS build from scratch.
...
* [moros](https://github.com/vinc/moros) ⭐ 1,094 | 🐛 20 | 🌐 Rust | 📅 2026-08-31 - MOROS is a hobby operating system written in Rust for the x86 architecture.
* [soso](https://github.com/ozkl/soso) ⭐ 990 | 🐛 1 | 🌐 C | 📅 2026-07-26 - Simple unix-like operating system written in Nasm assembly and mostly in C
* [Fomos](https://github.com/Ruddle/Fomos) ⭐ 973 | 🐛 5 | 🌐 Rust | 📅 2023-09-03 - Experimental OS, built with Rust.
* [Basekernel](https://github.com/dthain/basekernel) ⭐ 939 | 🐛 19 | 🌐 C | 📅 2026-01-08 - A simple OS kernel for research, teaching, and fun
* [BareMetal](http://www.returninfinity.com/), [GitHub](https://github.com/ReturnInfinity/BareMetal) ⭐ 921 | 🐛 1 | 🌐 Assembly | 📅 2026-06-12 - 64 bit operating system written in Assembly for x86-64
...
* [Fiwix](https://www.fiwix.org/), [GitHub](https://github.com/mikaku/Fiwix) ⭐ 687 | 🐛 5 | 🌐 C | 📅 2026-08-31 - A UNIX-like kernel for the i386 architecture.
...
* [Animal](https://github.com/frednora/animal) ⭐ 653 | 🐛 9 | 🌐 C | 📅 2026-08-31 - 32 bit multithreaded operating system (formerly Gramado)
...
* [MentOS](https://github.com/mentos-team/MentOS) ⭐ 304 | 🐛 28 | 🌐 C | 📅 2026-08-31 - An educational 32-bit linux-like Operating System.
...
* [Ethereal](https://github.com/sasdallas/Ethereal) ⭐ 159 | 🐛 0 | 🌐 C | 📅 2026-08-12 - Ethereal is an advanced modular operating system with support for networking and USB as well as a GUI-enabled userspace.
...
* [Northport](https://github.com/DeanoBurrito/northport) ⭐ 102 | 🐛 0 | 🌐 C++ | 📅 2026-08-26 - Monolithic kernel and support libraries for riscv64 and x86\_64.
...
* [Stanix](https://github.com/tayoky/stanix) ⭐ 48 | 🐛 0 | 🌐 C | 📅 2026-08-31 - An open source modular hobby OS in C, with features such as dynamic linking and a page cache.
...
* [Linux](https://github.com/torvalds/linux) ⭐ 245,474 | 🐛 3 | 🌐 C | 📅 2026-08-31 - Linux kernel
* [MS-DOS](https://github.com/microsoft/MS-DOS) ⚠️ Archived - The original sources of MS-DOS 1.25 and 2.0
* [ReactOS](https://reactos.org/), [Github](https://github.com/reactos/reactos) ⭐ 18,011 | 🐛 213 | 🌐 C | 📅 2026-08-31 - A free Windows-compatible Operating System
* [FreeBSD](https://freebsd.org/), [Github](https://github.com/freebsd/freebsd) ⭐ 9,301 | 🐛 177 | 🌐 C | 📅 2026-08-31 - Unix-like operating system based on the BSD
* [OpenBSD](https://www.openbsd.org/), [Github](https://github.com/openbsd/src) ⭐ 3,866 | 🐛 1 | 🌐 C | 📅 2026-08-31 - Unix-like operating system based on the BSD
* [Darwin XNU](https://github.com/apple-oss-distributions/xnu) ⭐ 3,553 | 🐛 1 | 🌐 C | 📅 2026-06-18 - The XNU kernel source code for use in MacOS and iOS
* [Minix](https://www.minix3.org/), [Github](https://github.com/Stichting-MINIX-Research-Foundation/minix) ⭐ 3,497 | 🐛 126 | 🌐 C | 📅 2024-03-18 - Unix-like operating system based on a microkernel architecture
* [Haiku](https://github.com/haiku/haiku) ⭐ 2,333 | 🐛 0 | 🌐 C++ | 📅 2026-08-31 - BeOS inspired OS
* [NetBSD](https://www.netbsd.org/), [Github](https://github.com/netbsd/src) ⭐ 979 | 🐛 16 | 🌐 C | 📅 2026-08-11 - Unix-like operating system based on the BSD
...
* [How to Make a Computer Operating System](https://github.com/SamyPesse/How-to-Make-a-Computer-Operating-System) ⭐ 22,416 | 🐛 86 | 🌐 C | 📅 2021-12-16 - in C++
...
* [os-tutorial - How to create an OS from scratch](https://github.com/cfenollosa/os-tutorial) ⭐ 30,681 | 🐛 130 | 🌐 C | 📅 2026-02-04 by Carlos Fenollosa
* [Learning operating system development using Linux kernel and Raspberry Pi](https://github.com/s-matyukevich/raspberry-pi-os) ⭐ 13,922 | 🐛 66 | 🌐 C | 📅 2024-03-29
...
* [Build a minimal multi-tasking OS kernel for ARM from scratch](https://github.com/jserv/mini-arm-os) ⭐ 1,256 | 🐛 2 | 🌐 C | 📅 2025-12-14 by Jim Huang
* [Presentation on how the Linux kernel is developed](https://github.com/gregkh/kernel-development) ⭐ 685 | 🐛 0 | 🌐 TeX | 📅 2026-08-28 by Greg Kroah-Hartman
...
* [xairys Linux Kernel Exploitation](https://github.com/xairy/linux-kernel-exploitation) ⭐ 6,621 | 🐛 0 | 📅 2026-08-14

* [syzkaller](https://github.com/google/syzkaller) ⭐ 6,314 | 🐛 621 | 🌐 Go | 📅 2026-08-31 kernel fuzzer
...
* [virtme-ng](https://github.com/arighi/virtme-ng) ⭐ 876 | 🐛 30 | 🌐 Python | 📅 2026-08-26 - quickly build and run kernels inside a virtualized snapshot of your live system
...
* [b4](https://github.com/mricon/b4) ⭐ 142 | 🐛 46 | 🌐 Python | 📅 2026-08-25, [docu](https://b4.docs.kernel.org/en/latest/), a tool to help with email-based patch workflows
* [hackermail](https://github.com/sjp38/hackermail) ⭐ 66 | 🐛 0 | 🌐 Python | 📅 2026-08-26 a mails management tool for hackers who collaborate using mailing lists
* [clang-extract](https://github.com/SUSE/clang-extract) ⭐ 33 | 🐛 17 | 🌐 C++ | 📅 2026-08-29 a tool to extract code content from source files using the clang and LLVM infrastructure.
