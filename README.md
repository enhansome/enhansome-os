...
* [Serenity](https://github.com/SerenityOS/serenity) ⭐ 33,760 | 🐛 737 | 🌐 C++ | 📅 2026-08-18 - Graphical Unix-like operating system for x86 computers
...
* [Redox](https://github.com/redox-os/redox) ⭐ 16,512 | 🐛 183 | 🌐 Rust | 📅 2026-08-18 - written in Rust
* [Bottlerocket OS](https://github.com/bottlerocket-os/bottlerocket) ⭐ 9,662 | 🐛 196 | 🌐 Rust | 📅 2026-08-05- Linux-based OS meant for hosting containers.
* [FreeRTOS](https://www.freertos.org/), [GitHub](https://github.com/FreeRTOS/FreeRTOS) ⭐ 7,696 | 🐛 33 | 🌐 C | 📅 2026-07-22 - IoT operating system for microcontrollers, by Amazon.
* [NodeOS](https://github.com/NodeOS/NodeOS) ⭐ 7,345 | 🐛 163 | 🌐 Shell | 📅 2023-03-07 - OS using NodeJS and Linux
* [RavynOS](https://github.com/ravynsoft/ravynos) ⭐ 6,886 | 🐛 84 | 🌐 C | 📅 2026-08-16 - A BSD-based OS project that aims to provide an experience like and some compatibility with macOS (formerly known as airyxOS)
* [ToaruOS](https://github.com/klange/toaruos) ⭐ 6,820 | 🐛 70 | 🌐 C | 📅 2026-08-18 - Hobby operating system from scratch
* [tock](https://www.tockos.org/), [GitHub](https://github.com/tock/tock) ⭐ 6,413 | 🐛 200 | 🌐 Rust | 📅 2026-08-18 - A secure embedded operating system for microcontrollers
* [TempleOS](https://github.com/minexew/TempleOS) ⭐ 4,765 | 🐛 17 | 🌐 HolyC | 📅 2023-12-03 - Religious OS :-)
* [Unikraft](https://github.com/unikraft/unikraft) ⭐ 3,825 | 🐛 356 | 🌐 C | 📅 2026-08-12 - A modular unikernel for specialization, high efficiency, performance, and security; Linux/POSIX-compatible; mostly in C
* [Maestro](https://github.com/maestro-os/maestro) ⭐ 3,325 | 🐛 9 | 🌐 Rust | 📅 2026-08-11, [Blog](https://blog.lenot.re) - Operating system written in Rust, aiming to be a lightweight version of Linux
* [Theseus](https://github.com/theseus-os/Theseus) ⭐ 3,182 | 🐛 70 | 🌐 Rust | 📅 2024-09-22 - A modern experimental OS written from scratch in Rust to explore novel OS structure and state management techniques.
* [Nanos](https://github.com/nanovms/nanos) ⭐ 3,179 | 🐛 79 | 🌐 C | 📅 2026-08-09 - Unikernel that is linux-compatible, written in C
* [tilck](https://github.com/vvaltchev/tilck) ⭐ 3,122 | 🐛 0 | 🌐 C | 📅 2026-08-03 - A Tiny Linux-Compatible Kernel.
* [skiftOS](https://skiftos.org/), [GitHub](https://github.com/skiftOS/skift) ⭐ 2,981 | 🐛 7 | 🌐 C++ | 📅 2026-07-08 - A simple, handmade, operating system with a graphical user interface.
* [Minoca OS](https://github.com/minoca/os) ⭐ 2,790 | 🐛 23 | 🌐 C | 📅 2021-12-17 - General purpose OS, written in C
* [PureDarwin](https://github.com/PureDarwin/PureDarwin/wiki) ⭐ 2,663 | 🐛 3 | 🌐 C | 📅 2026-08-18 - PureDarwin is a community project to extend Darwin into a complete, usable operating system
* [gopher-os](https://github.com/gopher-os/gopher-os) ⭐ 2,619 | 🐛 8 | 🌐 Go | 📅 2020-08-29 - A proof of concept OS kernel written in Go
* [ZealOS](https://github.com/Zeal-Operating-System/ZealOS) ⭐ 2,373 | 🐛 56 | 🌐 HolyC | 📅 2026-07-31 - The Zeal Operating System is a modernized, professional fork of the 64-bit Temple Operating System, TempleOS.
* [eggos](https://github.com/icexin/eggos) ⭐ 2,322 | 🐛 26 | 🌐 Go | 📅 2023-07-22 - A Go unikernel running on x86 bare metal
...
* [managarm](https://github.com/managarm/managarm) ⭐ 1,964 | 🐛 215 | 🌐 C++ | 📅 2026-08-17 - Pragmatic microkernel-based OS with fully asynchronous I/O
* [Thor](https://github.com/wichtounet/thor-os) ⭐ 1,719 | 🐛 2 | 🌐 C++ | 📅 2024-11-19 - 64bit operating system mostly written in C++
* [octox](https://github.com/o8vm/octox) ⭐ 1,638 | 🐛 3 | 🌐 Rust | 📅 2025-09-24 - Unix-like OS in Rust inspired by xv6-riscv
* [HelenOS](https://github.com/HelenOS/helenos) ⭐ 1,578 | 🐛 10 | 🌐 C | 📅 2026-07-09 - multikernel multiserver OS
...
* [LemonOS](https://lemonos.org/), [GitHub](https://github.com/fido2020/Lemon-OS) ⭐ 1,296 | 🐛 15 | 🌐 C++ | 📅 2024-11-23 - UNIX-like 64-bit operating system written in C++.
* [DragonOS](https://github.com/fslongjin/DragonOS) ⭐ 1,200 | 🐛 168 | 🌐 Rust | 📅 2026-08-18 - An x86-64 OS build from scratch.
...
* [moros](https://github.com/vinc/moros) ⭐ 1,091 | 🐛 22 | 🌐 Rust | 📅 2026-08-17 - MOROS is a hobby operating system written in Rust for the x86 architecture.
* [soso](https://github.com/ozkl/soso) ⭐ 987 | 🐛 1 | 🌐 C | 📅 2026-07-26 - Simple unix-like operating system written in Nasm assembly and mostly in C
...
* [BareMetal](http://www.returninfinity.com/), [GitHub](https://github.com/ReturnInfinity/BareMetal) ⭐ 918 | 🐛 1 | 🌐 Assembly | 📅 2026-06-12 - 64 bit operating system written in Assembly for x86-64
* [cavOS](https://github.com/malwarepad/cavOS) ⭐ 731 | 🐛 5 | 🌐 C | 📅 2026-06-13 - Amd64 operating system in C. Trying to make a full OS, with a simple and readable codebase
* [Fiwix](https://www.fiwix.org/), [GitHub](https://github.com/mikaku/Fiwix) ⭐ 683 | 🐛 5 | 🌐 C | 📅 2026-08-17 - A UNIX-like kernel for the i386 architecture.
...
* [Animal](https://github.com/frednora/animal) ⭐ 653 | 🐛 9 | 🌐 C | 📅 2026-08-18 - 32 bit multithreaded operating system (formerly Gramado)
...
* [Cyjon](https://github.com/CorruptedByCPU/Cyjon/) ⭐ 462 | 🐛 0 | 🌐 Assembly | 📅 2024-08-26 - pure x64 assembly language operating system (related to [Fern-Night](https://github.com/CorruptedByCPU/Fern-Night/) ⭐ 20 | 🐛 0 | 🌐 C | 📅 2024-08-16 project).
...
* [PathOS](http://path-os.duckdns.org/) - Hobby OS based on [MikeOS](https://github.com/mig-hub/mikeOS) ⭐ 436 | 🐛 4 | 🌐 Assembly | 📅 2022-07-12, written in Assembly Language
...
* [MentOS](https://github.com/mentos-team/MentOS) ⭐ 301 | 🐛 10 | 🌐 C | 📅 2026-08-17 - An educational 32-bit linux-like Operating System.
...
* [Ethereal](https://github.com/sasdallas/Ethereal) ⭐ 154 | 🐛 0 | 🌐 C | 📅 2026-08-12 - Ethereal is an advanced modular operating system with support for networking and USB as well as a GUI-enabled userspace.
* [BoneOS](https://github.com/Bone-Project/BoneOS) ⭐ 140 | 🐛 13 | 🌐 C | 📅 2024-08-12- OS for everyone built by everyone
* [ExectOS](https://git.codingworkshop.eu.org/xt-sys/exectos), [GitHub](https://github.com/xt-sys/exectos) ⭐ 138 | 🐛 0 | 🌐 C++ | 📅 2026-08-18 - ExectOS is a modern, EFI-enabled, general purpose operating system written from scratch and implementing the XT architecture. It runs on x86 and x86\_64 architectures and provides NT drivers compatibility layer.
...
* [Northport](https://github.com/DeanoBurrito/northport) ⭐ 102 | 🐛 0 | 🌐 C++ | 📅 2026-08-16 - Monolithic kernel and support libraries for riscv64 and x86\_64.
...
* [Sanos](http://www.jbox.dk/sanos/), [GitHub](https://github.com/ringgaard/sanos) ⭐ 85 | 🐛 4 | 🌐 C | 📅 2020-10-17 - Sanos is a minimalistic 32-bit x86 operating system kernel for network server appliances running on standard PC hardware.
...
* [Stanix](https://github.com/tayoky/stanix) ⭐ 46 | 🐛 0 | 🌐 C | 📅 2026-08-18 - An open source modular hobby OS in C, with features such as dynamic linking and a page cache.
...
* [Fern-Night](https://github.com/CorruptedByCPU/Fern-Night/) ⭐ 20 | 🐛 0 | 🌐 C | 📅 2024-08-16 - C language operating system (related to [Cyjon](https://github.com/CorruptedByCPU/Cyjon/) ⭐ 462 | 🐛 0 | 🌐 Assembly | 📅 2024-08-26 project).
...
* [Linux](https://github.com/torvalds/linux) ⭐ 243,178 | 🐛 3 | 🌐 C | 📅 2026-08-18 - Linux kernel
* [MS-DOS](https://github.com/microsoft/MS-DOS) ⚠️ Archived - The original sources of MS-DOS 1.25 and 2.0
* [ReactOS](https://reactos.org/), [Github](https://github.com/reactos/reactos) ⭐ 17,934 | 🐛 195 | 🌐 C | 📅 2026-08-18 - A free Windows-compatible Operating System
* [FreeBSD](https://freebsd.org/), [Github](https://github.com/freebsd/freebsd) ⭐ 9,277 | 🐛 164 | 🌐 C | 📅 2026-08-18 - Unix-like operating system based on the BSD
* [OpenBSD](https://www.openbsd.org/), [Github](https://github.com/openbsd/src) ⭐ 3,859 | 🐛 1 | 🌐 C | 📅 2026-08-18 - Unix-like operating system based on the BSD
* [Darwin XNU](https://github.com/apple-oss-distributions/xnu) ⭐ 3,514 | 🐛 1 | 🌐 C | 📅 2026-06-18 - The XNU kernel source code for use in MacOS and iOS
...
* [Haiku](https://github.com/haiku/haiku) ⭐ 2,315 | 🐛 0 | 🌐 C++ | 📅 2026-08-17 - BeOS inspired OS
...
* [How to Make a Computer Operating System](https://github.com/SamyPesse/How-to-Make-a-Computer-Operating-System) ⭐ 22,408 | 🐛 86 | 🌐 C | 📅 2021-12-16 - in C++
...
* [os-tutorial - How to create an OS from scratch](https://github.com/cfenollosa/os-tutorial) ⭐ 30,657 | 🐛 130 | 🌐 C | 📅 2026-02-04 by Carlos Fenollosa
* [Learning operating system development using Linux kernel and Raspberry Pi](https://github.com/s-matyukevich/raspberry-pi-os) ⭐ 13,912 | 🐛 66 | 🌐 C | 📅 2024-03-29
* [How to write a Linux kernel patch and submit it](https://github.com/gregkh/kernel-tutorial) ⭐ 1,264 | 🐛 1 | 📅 2021-03-26 by Greg Kroah-Hartman
...
* [Presentation on how the Linux kernel is developed](https://github.com/gregkh/kernel-development) ⭐ 685 | 🐛 0 | 🌐 TeX | 📅 2026-07-28 by Greg Kroah-Hartman
...
* [xairys Linux Kernel Exploitation](https://github.com/xairy/linux-kernel-exploitation) ⭐ 6,594 | 🐛 0 | 📅 2026-08-14

* [syzkaller](https://github.com/google/syzkaller) ⭐ 6,302 | 🐛 617 | 🌐 Go | 📅 2026-08-17 kernel fuzzer
...
* [virtme-ng](https://github.com/arighi/virtme-ng) ⭐ 869 | 🐛 32 | 🌐 Python | 📅 2026-08-18 - quickly build and run kernels inside a virtualized snapshot of your live system
...
* [hackermail](https://github.com/sjp38/hackermail) ⭐ 66 | 🐛 0 | 🌐 Python | 📅 2026-08-16 a mails management tool for hackers who collaborate using mailing lists
* [clang-extract](https://github.com/SUSE/clang-extract) ⭐ 33 | 🐛 17 | 🌐 C++ | 📅 2026-05-29 a tool to extract code content from source files using the clang and LLVM infrastructure.
