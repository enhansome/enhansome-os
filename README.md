...
* [Serenity](https://github.com/SerenityOS/serenity) ⭐ 33,762 | 🐛 739 | 🌐 C++ | 📅 2026-08-19 - Graphical Unix-like operating system for x86 computers
...
* [Redox](https://github.com/redox-os/redox) ⭐ 16,522 | 🐛 183 | 🌐 Rust | 📅 2026-08-20 - written in Rust
...
* [FreeRTOS](https://www.freertos.org/), [GitHub](https://github.com/FreeRTOS/FreeRTOS) ⭐ 7,701 | 🐛 33 | 🌐 C | 📅 2026-07-22 - IoT operating system for microcontrollers, by Amazon.
* [NodeOS](https://github.com/NodeOS/NodeOS) ⭐ 7,345 | 🐛 163 | 🌐 Shell | 📅 2023-03-07 - OS using NodeJS and Linux
* [RavynOS](https://github.com/ravynsoft/ravynos) ⭐ 6,888 | 🐛 84 | 🌐 C | 📅 2026-08-19 - A BSD-based OS project that aims to provide an experience like and some compatibility with macOS (formerly known as airyxOS)
* [ToaruOS](https://github.com/klange/toaruos) ⭐ 6,823 | 🐛 70 | 🌐 C | 📅 2026-08-20 - Hobby operating system from scratch
* [tock](https://www.tockos.org/), [GitHub](https://github.com/tock/tock) ⭐ 6,416 | 🐛 202 | 🌐 Rust | 📅 2026-08-20 - A secure embedded operating system for microcontrollers
* [TempleOS](https://github.com/minexew/TempleOS) ⭐ 4,772 | 🐛 17 | 🌐 HolyC | 📅 2023-12-03 - Religious OS :-)
...
* [Maestro](https://github.com/maestro-os/maestro) ⭐ 3,325 | 🐛 9 | 🌐 Rust | 📅 2026-08-20, [Blog](https://blog.lenot.re) - Operating system written in Rust, aiming to be a lightweight version of Linux
...
* [Nanos](https://github.com/nanovms/nanos) ⭐ 3,180 | 🐛 81 | 🌐 C | 📅 2026-08-09 - Unikernel that is linux-compatible, written in C
* [tilck](https://github.com/vvaltchev/tilck) ⭐ 3,122 | 🐛 0 | 🌐 C | 📅 2026-08-03 - A Tiny Linux-Compatible Kernel.
* [skiftOS](https://skiftos.org/), [GitHub](https://github.com/skiftOS/skift) ⭐ 2,983 | 🐛 7 | 🌐 C++ | 📅 2026-07-08 - A simple, handmade, operating system with a graphical user interface.
...
* [managarm](https://github.com/managarm/managarm) ⭐ 1,965 | 🐛 214 | 🌐 C++ | 📅 2026-08-20 - Pragmatic microkernel-based OS with fully asynchronous I/O
...
* [moros](https://github.com/vinc/moros) ⭐ 1,090 | 🐛 23 | 🌐 Rust | 📅 2026-08-20 - MOROS is a hobby operating system written in Rust for the x86 architecture.
...
* [Fiwix](https://www.fiwix.org/), [GitHub](https://github.com/mikaku/Fiwix) ⭐ 684 | 🐛 5 | 🌐 C | 📅 2026-08-17 - A UNIX-like kernel for the i386 architecture.
...
* [Animal](https://github.com/frednora/animal) ⭐ 653 | 🐛 9 | 🌐 C | 📅 2026-08-20 - 32 bit multithreaded operating system (formerly Gramado)
...
* [menix](https://github.com/menix-os/menix) ⭐ 375 | 🐛 4 | 🌐 Rust | 📅 2026-08-07 - A minimal and expandable Unix-like operating system.
...
* [L4re](https://github.com/kernkonzept/l4re-core) ⭐ 106 | 🐛 1 | 🌐 C++ | 📅 2026-08-20 - Operating system and hypervisor for security/safety-critical and virtualization-enabled applications.
* [Northport](https://github.com/DeanoBurrito/northport) ⭐ 102 | 🐛 0 | 🌐 C++ | 📅 2026-08-20 - Monolithic kernel and support libraries for riscv64 and x86\_64.
...
* [Stanix](https://github.com/tayoky/stanix) ⭐ 46 | 🐛 0 | 🌐 C | 📅 2026-08-20 - An open source modular hobby OS in C, with features such as dynamic linking and a page cache.
...
* [Linux](https://github.com/torvalds/linux) ⭐ 243,409 | 🐛 3 | 🌐 C | 📅 2026-08-20 - Linux kernel
* [MS-DOS](https://github.com/microsoft/MS-DOS) ⚠️ Archived - The original sources of MS-DOS 1.25 and 2.0
* [ReactOS](https://reactos.org/), [Github](https://github.com/reactos/reactos) ⭐ 17,941 | 🐛 199 | 🌐 C | 📅 2026-08-19 - A free Windows-compatible Operating System
* [FreeBSD](https://freebsd.org/), [Github](https://github.com/freebsd/freebsd) ⭐ 9,281 | 🐛 170 | 🌐 C | 📅 2026-08-20 - Unix-like operating system based on the BSD
* [OpenBSD](https://www.openbsd.org/), [Github](https://github.com/openbsd/src) ⭐ 3,863 | 🐛 1 | 🌐 C | 📅 2026-08-20 - Unix-like operating system based on the BSD
* [Darwin XNU](https://github.com/apple-oss-distributions/xnu) ⭐ 3,523 | 🐛 1 | 🌐 C | 📅 2026-06-18 - The XNU kernel source code for use in MacOS and iOS
...
* [Haiku](https://github.com/haiku/haiku) ⭐ 2,316 | 🐛 0 | 🌐 C++ | 📅 2026-08-20 - BeOS inspired OS
...
* [xairys Linux Kernel Exploitation](https://github.com/xairy/linux-kernel-exploitation) ⭐ 6,598 | 🐛 0 | 📅 2026-08-14

* [syzkaller](https://github.com/google/syzkaller) ⭐ 6,304 | 🐛 617 | 🌐 Go | 📅 2026-08-17 kernel fuzzer
...
* [virtme-ng](https://github.com/arighi/virtme-ng) ⭐ 869 | 🐛 29 | 🌐 Python | 📅 2026-08-20 - quickly build and run kernels inside a virtualized snapshot of your live system
...
* [hackermail](https://github.com/sjp38/hackermail) ⭐ 66 | 🐛 0 | 🌐 Python | 📅 2026-08-20 a mails management tool for hackers who collaborate using mailing lists
* [clang-extract](https://github.com/SUSE/clang-extract) ⭐ 33 | 🐛 18 | 🌐 C++ | 📅 2026-05-29 a tool to extract code content from source files using the clang and LLVM infrastructure.
