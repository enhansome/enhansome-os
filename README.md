...
* [Serenity](https://github.com/SerenityOS/serenity) ⭐ 33,771 | 🐛 737 | 🌐 C++ | 📅 2026-08-23 - Graphical Unix-like operating system for x86 computers
* [Windows 95 in Electron](https://github.com/felixrieseberg/windows95) ⭐ 24,198 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-20 - Hobby Windows 95 implementation in Electron
* [Redox](https://github.com/redox-os/redox) ⭐ 16,525 | 🐛 183 | 🌐 Rust | 📅 2026-08-23 - written in Rust
* [Bottlerocket OS](https://github.com/bottlerocket-os/bottlerocket) ⭐ 9,662 | 🐛 195 | 🌐 Rust | 📅 2026-08-19- Linux-based OS meant for hosting containers.
* [FreeRTOS](https://www.freertos.org/), [GitHub](https://github.com/FreeRTOS/FreeRTOS) ⭐ 7,711 | 🐛 35 | 🌐 C | 📅 2026-07-22 - IoT operating system for microcontrollers, by Amazon.
* [NodeOS](https://github.com/NodeOS/NodeOS) ⭐ 7,345 | 🐛 163 | 🌐 Shell | 📅 2023-03-07 - OS using NodeJS and Linux
* [RavynOS](https://github.com/ravynsoft/ravynos) ⭐ 6,887 | 🐛 84 | 🌐 C | 📅 2026-08-19 - A BSD-based OS project that aims to provide an experience like and some compatibility with macOS (formerly known as airyxOS)
* [ToaruOS](https://github.com/klange/toaruos) ⭐ 6,827 | 🐛 65 | 🌐 C | 📅 2026-08-23 - Hobby operating system from scratch
* [tock](https://www.tockos.org/), [GitHub](https://github.com/tock/tock) ⭐ 6,418 | 🐛 202 | 🌐 Rust | 📅 2026-08-22 - A secure embedded operating system for microcontrollers
* [TempleOS](https://github.com/minexew/TempleOS) ⭐ 4,780 | 🐛 17 | 🌐 HolyC | 📅 2023-12-03 - Religious OS :-)
* [Unikraft](https://github.com/unikraft/unikraft) ⭐ 3,830 | 🐛 357 | 🌐 C | 📅 2026-08-12 - A modular unikernel for specialization, high efficiency, performance, and security; Linux/POSIX-compatible; mostly in C
* [Maestro](https://github.com/maestro-os/maestro) ⭐ 3,326 | 🐛 10 | 🌐 Rust | 📅 2026-08-23, [Blog](https://blog.lenot.re) - Operating system written in Rust, aiming to be a lightweight version of Linux
* [Nanos](https://github.com/nanovms/nanos) ⭐ 3,183 | 🐛 81 | 🌐 C | 📅 2026-08-22 - Unikernel that is linux-compatible, written in C
...
* [tilck](https://github.com/vvaltchev/tilck) ⭐ 3,123 | 🐛 0 | 🌐 C | 📅 2026-08-03 - A Tiny Linux-Compatible Kernel.
...
* [Minoca OS](https://github.com/minoca/os) ⭐ 2,792 | 🐛 23 | 🌐 C | 📅 2021-12-17 - General purpose OS, written in C
* [PureDarwin](https://github.com/PureDarwin/PureDarwin/wiki) ⭐ 2,668 | 🐛 3 | 🌐 C | 📅 2026-08-18 - PureDarwin is a community project to extend Darwin into a complete, usable operating system
* [gopher-os](https://github.com/gopher-os/gopher-os) ⭐ 2,620 | 🐛 8 | 🌐 Go | 📅 2020-08-29 - A proof of concept OS kernel written in Go
...
* [managarm](https://github.com/managarm/managarm) ⭐ 1,967 | 🐛 214 | 🌐 C++ | 📅 2026-08-23 - Pragmatic microkernel-based OS with fully asynchronous I/O
* [Thor](https://github.com/wichtounet/thor-os) ⭐ 1,720 | 🐛 2 | 🌐 C++ | 📅 2024-11-19 - 64bit operating system mostly written in C++
* [octox](https://github.com/o8vm/octox) ⭐ 1,638 | 🐛 3 | 🌐 Rust | 📅 2025-09-24 - Unix-like OS in Rust inspired by xv6-riscv
* [HelenOS](https://github.com/HelenOS/helenos) ⭐ 1,579 | 🐛 10 | 🌐 C | 📅 2026-07-09 - multikernel multiserver OS
* [KnightOS](https://github.com/KnightOS/KnightOS) ⭐ 1,316 | 🐛 108 | 🌐 Assembly | 📅 2021-05-02 - for z80 calculators
...
* [DragonOS](https://github.com/fslongjin/DragonOS) ⭐ 1,201 | 🐛 164 | 🌐 Rust | 📅 2026-08-23 - An x86-64 OS build from scratch.
...
* [moros](https://github.com/vinc/moros) ⭐ 1,090 | 🐛 20 | 🌐 Rust | 📅 2026-08-23 - MOROS is a hobby operating system written in Rust for the x86 architecture.
...
* [Basekernel](https://github.com/dthain/basekernel) ⭐ 936 | 🐛 19 | 🌐 C | 📅 2026-01-08 - A simple OS kernel for research, teaching, and fun
* [BareMetal](http://www.returninfinity.com/), [GitHub](https://github.com/ReturnInfinity/BareMetal) ⭐ 919 | 🐛 1 | 🌐 Assembly | 📅 2026-06-12 - 64 bit operating system written in Assembly for x86-64
* [cavOS](https://github.com/malwarepad/cavOS) ⭐ 733 | 🐛 5 | 🌐 C | 📅 2026-06-13 - Amd64 operating system in C. Trying to make a full OS, with a simple and readable codebase
* [Fiwix](https://www.fiwix.org/), [GitHub](https://github.com/mikaku/Fiwix) ⭐ 684 | 🐛 5 | 🌐 C | 📅 2026-08-21 - A UNIX-like kernel for the i386 architecture.
...
* [Animal](https://github.com/frednora/animal) ⭐ 653 | 🐛 9 | 🌐 C | 📅 2026-08-23 - 32 bit multithreaded operating system (formerly Gramado)
...
* [Cyjon](https://github.com/CorruptedByCPU/Cyjon/) ⭐ 464 | 🐛 0 | 🌐 Assembly | 📅 2024-08-26 - pure x64 assembly language operating system (related to [Fern-Night](https://github.com/CorruptedByCPU/Fern-Night/) ⭐ 20 | 🐛 0 | 🌐 C | 📅 2024-08-16 project).
* [MollenOS](https://github.com/Meulengracht/MollenOS) ⭐ 454 | 🐛 21 | 🌐 C | 📅 2024-11-25 - MollenOS/Vali is a modern operating system that is built with focus on abstraction and a modular design, allowing anyone to port it to any architecture. It currently targets the x86-32 and x86-64 platform
...
* [menix](https://github.com/menix-os/menix) ⭐ 377 | 🐛 4 | 🌐 Rust | 📅 2026-08-07 - A minimal and expandable Unix-like operating system.
...
* [MentOS](https://github.com/mentos-team/MentOS) ⭐ 302 | 🐛 29 | 🌐 C | 📅 2026-08-22 - An educational 32-bit linux-like Operating System.
...
* [L4re](https://github.com/kernkonzept/l4re-core) ⭐ 105 | 🐛 1 | 🌐 C++ | 📅 2026-08-20 - Operating system and hypervisor for security/safety-critical and virtualization-enabled applications.
* [Northport](https://github.com/DeanoBurrito/northport) ⭐ 102 | 🐛 0 | 🌐 C++ | 📅 2026-08-21 - Monolithic kernel and support libraries for riscv64 and x86\_64.
...
* [Stanix](https://github.com/tayoky/stanix) ⭐ 46 | 🐛 0 | 🌐 C | 📅 2026-08-23 - An open source modular hobby OS in C, with features such as dynamic linking and a page cache.
...
* [Fern-Night](https://github.com/CorruptedByCPU/Fern-Night/) ⭐ 20 | 🐛 0 | 🌐 C | 📅 2024-08-16 - C language operating system (related to [Cyjon](https://github.com/CorruptedByCPU/Cyjon/) ⭐ 464 | 🐛 0 | 🌐 Assembly | 📅 2024-08-26 project).
...
* [Linux](https://github.com/torvalds/linux) ⭐ 243,949 | 🐛 3 | 🌐 C | 📅 2026-08-23 - Linux kernel
* [MS-DOS](https://github.com/microsoft/MS-DOS) ⚠️ Archived - The original sources of MS-DOS 1.25 and 2.0
* [ReactOS](https://reactos.org/), [Github](https://github.com/reactos/reactos) ⭐ 17,946 | 🐛 204 | 🌐 C | 📅 2026-08-23 - A free Windows-compatible Operating System
* [FreeBSD](https://freebsd.org/), [Github](https://github.com/freebsd/freebsd) ⭐ 9,286 | 🐛 174 | 🌐 C | 📅 2026-08-23 - Unix-like operating system based on the BSD
* [OpenBSD](https://www.openbsd.org/), [Github](https://github.com/openbsd/src) ⭐ 3,865 | 🐛 1 | 🌐 C | 📅 2026-08-23 - Unix-like operating system based on the BSD
* [Darwin XNU](https://github.com/apple-oss-distributions/xnu) ⭐ 3,527 | 🐛 1 | 🌐 C | 📅 2026-06-18 - The XNU kernel source code for use in MacOS and iOS
...
* [Haiku](https://github.com/haiku/haiku) ⭐ 2,316 | 🐛 0 | 🌐 C++ | 📅 2026-08-23 - BeOS inspired OS
* [NetBSD](https://www.netbsd.org/), [Github](https://github.com/netbsd/src) ⭐ 975 | 🐛 15 | 🌐 C | 📅 2026-08-11 - Unix-like operating system based on the BSD
...
* [os-tutorial - How to create an OS from scratch](https://github.com/cfenollosa/os-tutorial) ⭐ 30,661 | 🐛 130 | 🌐 C | 📅 2026-02-04 by Carlos Fenollosa
...
* [xairys Linux Kernel Exploitation](https://github.com/xairy/linux-kernel-exploitation) ⭐ 6,599 | 🐛 0 | 📅 2026-08-14

* [syzkaller](https://github.com/google/syzkaller) ⭐ 6,305 | 🐛 622 | 🌐 Go | 📅 2026-08-21 kernel fuzzer

* [kernel-security-learning](https://github.com/bsauce/kernel-security-learning) ⭐ 771 | 🐛 0 | 🌐 C | 📅 2026-05-29
...
* [virtme-ng](https://github.com/arighi/virtme-ng) ⭐ 870 | 🐛 29 | 🌐 Python | 📅 2026-08-20 - quickly build and run kernels inside a virtualized snapshot of your live system
...
* [hackermail](https://github.com/sjp38/hackermail) ⭐ 66 | 🐛 0 | 🌐 Python | 📅 2026-08-22 a mails management tool for hackers who collaborate using mailing lists
* [clang-extract](https://github.com/SUSE/clang-extract) ⭐ 33 | 🐛 17 | 🌐 C++ | 📅 2026-08-21 a tool to extract code content from source files using the clang and LLVM infrastructure.
