...
* [Serenity](https://github.com/SerenityOS/serenity) ⭐ 33,821 | 🐛 742 | 🌐 C++ | 📅 2026-09-12 - Graphical Unix-like operating system for x86 computers
...
* [Redox](https://github.com/redox-os/redox) ⭐ 16,571 | 🐛 183 | 🌐 Rust | 📅 2026-09-13 - written in Rust
...
* [FreeRTOS](https://www.freertos.org/), [GitHub](https://github.com/FreeRTOS/FreeRTOS) ⭐ 7,791 | 🐛 35 | 🌐 C | 📅 2026-08-26 - IoT operating system for microcontrollers, by Amazon.
...
* [ToaruOS](https://github.com/klange/toaruos) ⭐ 6,830 | 🐛 65 | 🌐 C | 📅 2026-09-12 - Hobby operating system from scratch
* [tock](https://www.tockos.org/), [GitHub](https://github.com/tock/tock) ⭐ 6,442 | 🐛 214 | 🌐 Rust | 📅 2026-09-13 - A secure embedded operating system for microcontrollers
* [TempleOS](https://github.com/minexew/TempleOS) ⭐ 4,824 | 🐛 20 | 🌐 HolyC | 📅 2023-12-03 - Religious OS :-)
...
* [Maestro](https://github.com/maestro-os/maestro) ⭐ 3,334 | 🐛 11 | 🌐 Rust | 📅 2026-08-23, [Blog](https://blog.lenot.re) - Operating system written in Rust, aiming to be a lightweight version of Linux
...
* [tilck](https://github.com/vvaltchev/tilck) ⭐ 3,127 | 🐛 0 | 🌐 C | 📅 2026-09-13 - A Tiny Linux-Compatible Kernel.
...
* [PureDarwin](https://github.com/PureDarwin/PureDarwin/wiki) ⭐ 2,705 | 🐛 1 | 🌐 C | 📅 2026-09-13 - PureDarwin is a community project to extend Darwin into a complete, usable operating system
* [gopher-os](https://github.com/gopher-os/gopher-os) ⭐ 2,624 | 🐛 8 | 🌐 Go | 📅 2020-08-29 - A proof of concept OS kernel written in Go
* [ZealOS](https://github.com/Zeal-Operating-System/ZealOS) ⭐ 2,386 | 🐛 56 | 🌐 HolyC | 📅 2026-09-13 - The Zeal Operating System is a modernized, professional fork of the 64-bit Temple Operating System, TempleOS.
* [eggos](https://github.com/icexin/eggos) ⭐ 2,326 | 🐛 26 | 🌐 Go | 📅 2023-07-22 - A Go unikernel running on x86 bare metal
* [Vinix](https://github.com/vlang/vinix) ⭐ 2,242 | 🐛 31 | 🌐 V | 📅 2026-09-13 - Vinix is an effort to write a modern, fast, and useful operating system in the V programming language
* [managarm](https://github.com/managarm/managarm) ⭐ 1,977 | 🐛 222 | 🌐 C++ | 📅 2026-09-13 - Pragmatic microkernel-based OS with fully asynchronous I/O
...
* [DragonOS](https://github.com/fslongjin/DragonOS) ⭐ 1,205 | 🐛 165 | 🌐 Rust | 📅 2026-09-13 - An x86-64 OS build from scratch.
...
* [moros](https://github.com/vinc/moros) ⭐ 1,098 | 🐛 20 | 🌐 Rust | 📅 2026-09-13 - MOROS is a hobby operating system written in Rust for the x86 architecture.
...
* [cavOS](https://github.com/malwarepad/cavOS) ⭐ 736 | 🐛 5 | 🌐 C | 📅 2026-06-13 - Amd64 operating system in C. Trying to make a full OS, with a simple and readable codebase
...
* [Animal](https://github.com/frednora/animal) ⭐ 652 | 🐛 9 | 🌐 C | 📅 2026-09-13 - 32 bit multithreaded operating system (formerly Gramado)
...
* [MollenOS](https://github.com/Meulengracht/MollenOS) ⭐ 453 | 🐛 23 | 🌐 C | 📅 2026-09-13 - MollenOS/Vali is a modern operating system that is built with focus on abstraction and a modular design, allowing anyone to port it to any architecture. It currently targets the x86-32 and x86-64 platform
...
* [Ethereal](https://github.com/sasdallas/Ethereal) ⭐ 176 | 🐛 0 | 🌐 C | 📅 2026-08-12 - Ethereal is an advanced modular operating system with support for networking and USB as well as a GUI-enabled userspace.
...
* [Stanix](https://github.com/tayoky/stanix) ⭐ 48 | 🐛 0 | 🌐 C | 📅 2026-09-13 - An open source modular hobby OS in C, with features such as dynamic linking and a page cache.
...
* [AurixOS](https://github.com/aurixos/os) ⭐ 33 | 🐛 0 | 🌐 C | 📅 2026-09-13 - A small multiplatform Operating System designed for developers and creators
...
* [Linux](https://github.com/torvalds/linux) ⭐ 248,805 | 🐛 3 | 🌐 C | 📅 2026-09-13 - Linux kernel
* [MS-DOS](https://github.com/microsoft/MS-DOS) ⚠️ Archived - The original sources of MS-DOS 1.25 and 2.0
* [ReactOS](https://reactos.org/), [Github](https://github.com/reactos/reactos) ⭐ 18,084 | 🐛 222 | 🌐 C | 📅 2026-09-13 - A free Windows-compatible Operating System
* [FreeBSD](https://freebsd.org/), [Github](https://github.com/freebsd/freebsd) ⭐ 9,313 | 🐛 184 | 🌐 C | 📅 2026-09-13 - Unix-like operating system based on the BSD
* [OpenBSD](https://www.openbsd.org/), [Github](https://github.com/openbsd/src) ⭐ 3,875 | 🐛 1 | 🌐 C | 📅 2026-09-13 - Unix-like operating system based on the BSD
* [Darwin XNU](https://github.com/apple-oss-distributions/xnu) ⭐ 3,608 | 🐛 1 | 🌐 C | 📅 2026-06-18 - The XNU kernel source code for use in MacOS and iOS
...
* [Haiku](https://github.com/haiku/haiku) ⭐ 2,340 | 🐛 0 | 🌐 C++ | 📅 2026-09-13 - BeOS inspired OS
* [NetBSD](https://www.netbsd.org/), [Github](https://github.com/netbsd/src) ⭐ 986 | 🐛 17 | 🌐 C | 📅 2026-09-13 - Unix-like operating system based on the BSD
...
* [os-tutorial - How to create an OS from scratch](https://github.com/cfenollosa/os-tutorial) ⭐ 30,701 | 🐛 130 | 🌐 C | 📅 2026-02-04 by Carlos Fenollosa
* [Learning operating system development using Linux kernel and Raspberry Pi](https://github.com/s-matyukevich/raspberry-pi-os) ⭐ 13,931 | 🐛 66 | 🌐 C | 📅 2024-03-29
...
* [syzkaller](https://github.com/google/syzkaller) ⭐ 6,321 | 🐛 628 | 🌐 Go | 📅 2026-09-11 kernel fuzzer
